...
public class JFImpressos extends javax.swing.JFrame {

    public JFImpressos() {
        initComponents();
        tbImpressao.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        tbImpressao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                ...
                {"Leite", "R$ 10,00", "1"},
                {"Maçã", "R$ 2,00", "9"},
                {"Sucrilhos Celcocs", "R$ 100,00", "0,5"}
            },
            new String [] {
        ...
        jScrollPane1.setViewportView(tbImpressao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFImpressos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFImpressos().setVisible(true);
            }
        });
    }
